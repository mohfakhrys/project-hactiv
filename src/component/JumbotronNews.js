        ...
        return(
            ...
            <div class="jumbotron jumbotron-fluid" style={{marginLeft:"100px",marginRight:"100px"}}> 
                <div class="container">
                    ...
                    <h1 class="title">The International 2019 Collector’s Cache</h1>
                    <small className="date">June 7, 2019 - Dota Team</small>
                    <p class="lead mt-3 mb-3" style={{textAlign:"justify"}}>The final votes have been tallied and The International 2019 Collector’s Cache is now available, loaded with the top 18 item sets as voted on by the Dota 2 community.
                    ...
                    <h1 class="title">Collector’s Cache Battle Pass Vote</h1>
                    ...
                    <h1 class="title">The 7.22 Gameplay Update</h1>
                   ...
                   <div className="border-top border-dark mb-3 mt-3">
                    ...
                    <h1 class="title">Planetfall — Earthshaker Arcana</h1>
                    <small>May 24, 2019 - Dota Team</small>
