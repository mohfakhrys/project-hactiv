...
class JumbotronUpdate extends Component{
    render(){
        return(
            ...
            <div class="jumbotron jumbotron-fluid" style={{marginLeft:"100px",marginRight:"100px"}}> 
                <div class="container ">
                    <h1 className="title">Dota 2 Update - June 5th 2019</h1>
                    <small className="font-weight-bold">June 5, 2019 - Valve</small>
                    <p class="lead" style={{textAlign:"justify"}}>Added a new camera test convar "dota_camera_alternative" that takes a number input for different camera setting configurations. This convar will only be around short term and the input mappings may change.</p>
                </div>
                <div class="container border-top border-dark">
                    <h1 className="title mt-4">Dota 2 Update - May 29th, 2019</h1>
                    <small className="font-weight-bold">June 5, 2019 - Valve</small>
                    <p class="lead" style={{textAlign:"justify"}}>- Fixed Marksmanship's extra proc damage portion not being properly reduced by bonus armor</p>
                </div>
                <div class="container border-top border-dark">
                    <h1 className="title mt-4">Dota 2 Update - May 15th, 2019</h1>
                    <small className="font-weight-bold">June 5, 2019 - Valve</small>
                    <p class="lead"style={{textAlign:"justify"}}>* There was an issue that affected some players who used shovels in the first few hours of the battle pass release. We’ve granted additional shovels to the affected players.</p>
                </div>
                <div class="container border-top border-dark">
                    <h1 className="title mt-4">Dota 2 Update - May 10th, 2019</h1>
                    <small className="font-weight-bold">June 5, 2019 - Valve</small>
                    <p class="lead"style={{textAlign:"justify"}}>* Fixed issues related to MMR wager tokens</p>
                </div>
                <div class="container border-top border-dark">
                    <h1 className="title mt-4">Dota 2 Update - March 11, 2019</h1>
                    <small className="font-weight-bold">June 5, 2019 - Valve</small>
                    <p class="lead"style={{textAlign:"justify"}}>Custom Games API:
